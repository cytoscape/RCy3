...
# TODO: expandGroup (title, group.name, base.url) http://localhost:1234/v1/networks/52/groups/count
# TODO: collapseGroup (title, group.name, base.url) http://localhost:1234/v1/networks/52/groups/count
