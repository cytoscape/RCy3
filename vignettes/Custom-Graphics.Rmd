...
```{r}
setNodeCustomBarChart(c("gal1RGexp","gal4RGexp","gal80Rexp"), type = "GROUPED", colors = NULL,range = NULL, orientation = "VERTICAL", colAxis = FALSE,
  rangeAxis = FALSE, zeroLine = FALSE, axisWidth = 0.25,
  axisColor = "#000000", axisFontSize = 1, separation = 0,
  slot = 1)
```
...
```{r}
setNodeCustomPosition(nodeAnchor = "S", graphicAnchor = "N", slot = 1)
```

## Stripes
Next we are going to create stripes of gradient mappings using a horizontal "heatmap"" of the same three data columns and position the heatmap right above the node:

```{r}
setNodeCustomHeatMapChart(c("gal1RGexp","gal4RGexp","gal80Rexp"), colors = NULL, range = NULL,
  orientation = "HORIZONTAL", rangeAxis = FALSE, zeroLine = FALSE,
  axisWidth = 0.25, axisColor = "#000000", axisFontSize = 1, slot = 2)
...
```{r}
setNodeCustomPieChart(c("Radiality", "Degree"), colors = NULL, startAngle = 0,  slot = 3)
