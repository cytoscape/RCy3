...
#    toc: true 
vignette: >
  %\VignetteIndexEntry{7. Identifier mapping ~20 min}
...
The return value is a data fram of all the mappings between Ensembl and Entrez Gene
...
identifiers (or vice versa), but also a caution to be aware of the assumptions
involved when making this translation**, e.g., a typical gene encodes for many 
...
* Install the WikiPathways app from https://apps.cytoscape.org/apps/wikipathway
